                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <a href="{{ route('doctor.appointments.show', $appointment->follow_up_appointment_id) }}" 
                                           class="badge bg-info text-decoration-none">
                                            <i class="bi bi-arrow-repeat me-1"></i>
                                            Xem lịch hẹn lại #{{ $appointment->follow_up_appointment_id }}
                                        </a>
                                    </div>
                                    @endif
                                </div>
                            ...
                            <div class="card-body">
                                <ul class="list-unstyled small mb-0">
                                    <li class="mb-2">
                                        ...
                                        <strong>
                                            {{ \Carbon\Carbon::parse($appointment->created_at)->format('H:i d/m/Y') }}
                                        </strong>
                                    </li>
                                    ...
                                    <li class="mb-2">
                                        ...
                                        <strong>
                                            {{ \Carbon\Carbon::parse($appointment->confirmed_at)->format('H:i d/m/Y') }}
                                        </strong>
                                    </li>
                                    @endif
                                    ...
                                    <li class="mb-2">
                                        ...
                                        <strong>
                                            {{ \Carbon\Carbon::parse($appointment->completed_at)->format('H:i d/m/Y') }}
                                        </strong>
                                    </li>
                                    @endif
                                    ...
                                    <li>
                                        ...
                                        <strong>
                                            {{ \Carbon\Carbon::parse($appointment->cancelled_at)->format('H:i d/m/Y') }}
                                        </strong>
