...
@section('content')
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            <form
                action="{{ $schedule->id ? route('admin.schedules.update', $schedule->id) : route('admin.schedules.store') }}"
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="doctor_id" class="form-select" required {{ $schedule->id ? 'disabled' : '' }}>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="status" class="form-select">
                            ...
                            <option value="published"
                                {{ old('status', $schedule->status) == 'published' ? 'selected' : '' }}>
                ...
                <div class="alert alert-info d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-link btn-sm p-0 ms-2" onclick="calculateSlotsPreview()">Tính
                            lại</button>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="blocked_times" class="form-control" rows="2" placeholder='VD: ["14:00-14:30", "16:00-16:15"]'>{{ old('blocked_times', $schedule->blocked_times) }}</textarea>
