        ...
        <div class="container" style="max-width: 960px;">
            ...
            <div class="mb-4">
                ...
                <p class="text-muted small">
                    Tạo tài khoản và hồ sơ chuyên môn cho bác sĩ mới. Khi tạo bằng giao diện admin thì mật khẩu bác sĩ mặc
                    định là
            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-body p-4 p-md-5">
                    <h3 class="card-title h5 fw-bold text-secondary mb-4 d-flex align-items-center">
                        <svg class="me-2 text-success" width="20" height="20" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <form action="{{ route('admin.doctors.doctorStore') }}" method="POST">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="full_name" id="full_name" value="{{ old('full_name') }}"
                                    required class="form-control @error('full_name') is-invalid @enderror shadow-none py-2"
                            ...
                            {{-- Email --}}
                            <div class="col-md-6">
                                <label for="email" class="form-label fw-medium text-dark small">Email (Tài khoản đăng
                                    nhập)</label>
                            ...
                            {{-- Trình độ --}}
                            <div class="col-md-6">
                                <label for="qualification" class="form-label fw-medium text-dark small">Trình độ chuyên
                                    môn</label>
                            ...
                            {{-- Kinh nghiệm --}}
                            <div class="col-md-6">
                                <label for="years_of_experience" class="form-label fw-medium text-dark small">Số năm kinh
                                    nghiệm</label>
                            ...
                            {{-- Phí khám --}}
                            <div class="col-12">
                                <label for="consultation_fee" class="form-label fw-medium text-dark small">Phí khám
                                    (VNĐ)</label>
                            ...
                            {{-- Tiểu sử --}}
                            <div class="col-12">
                                <label for="bio" class="form-label fw-medium text-dark small">Tiểu sử / Giới
                                    thiệu</label>
                                <textarea name="bio" id="bio" rows="4"
                                    class="form-control @error('bio') is-invalid @enderror shadow-none"
                        ...
                        <div class="mt-5 pt-4 border-top d-flex align-items-center justify-content-end gap-3">
                            <a href="{{ route('admin.doctors.doctorManagement') }}"
                                class="btn btn-link text-decoration-none text-secondary fw-semibold small">
                                Hủy và quay lại
                            </a>

                            <button type="submit"
                                class="btn btn-success px-4 py-2 fw-bold text-uppercase small shadow-sm">
                                <svg class="me-2" width="16" height="16" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
