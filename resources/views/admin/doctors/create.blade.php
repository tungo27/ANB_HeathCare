            ...
            <div class="admin-container bg-white p-8 shadow sm:rounded-lg">
                ...
                <form action="{{ route('admin.doctors.doctorStore') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {{-- Số điện thoại --}}
                        <div class="form-group">
                            <label for="phone" class="form-label block font-medium text-gray-700">Số điện thoại</label>
                    ...
                    <div class="form-actions mt-8 flex justify-end space-x-3">
                        ...
                        <button type="submit"
                            class="inline-flex items-center px-4 py-2 bg-emerald-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-emerald-700 active:bg-emerald-900 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 transition ease-in-out duration-150 shadow-sm">
                            Lưu Bác sĩ
                        </button>
                    </div>
                </form>
