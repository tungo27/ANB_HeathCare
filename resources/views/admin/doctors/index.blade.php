...
@section('content')
    <div class="container py-5">
        ...
        {{-- Alerts --}}
        @if (session('success'))
            <div class="alert alert-success alert-dismissible fade show border-0 border-start border-4 border-success shadow-sm mb-4"
                role="alert">
                {{ session('success') }}
        ...
        @if (session('error'))
            <div class="alert alert-danger alert-dismissible fade show border-0 border-start border-4 border-danger shadow-sm mb-4"
                role="alert">
                {{ session('error') }}
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
