                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="bg-emerald-50 p-6 rounded-lg border border-emerald-100">
                        <div class="flex items-center space-x-4">
                            <img src="{{ $doctor->user->avatar_url ?? 'https://via.placeholder.com/150' }}" class="w-24 h-24 rounded-full object-cover border-4 border-emerald-200">
                            <div>
                    ...
                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="booking_date" min="{{ date('Y-m-d') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div id="booking_form" class="mt-6 hidden">
                            <div class="mb-4">
                                ...
                                <textarea id="symptoms" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"></textarea>
                            </div>
                            <button id="btn_confirm_booking" class="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-200 shadow-lg">
                ...
                .then(slots => {
                    ...
                    if (slots.length > 0) {
                        slots.forEach(slot => {
                            ...
                            btn.className = 'slot-btn border-2 border-blue-200 p-2 rounded text-center hover:bg-blue-50 transition-all';
