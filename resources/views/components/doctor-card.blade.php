...
<a href="/booking/{{ $doctor->user_id }}" class="w-full py-2 bg-teal-700 hover:bg-teal-800 text-white rounded-xl text-sm font-medium transition inline-block text-center">
    Chọn bác sĩ
</a>
</div>